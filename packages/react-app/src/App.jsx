...
/*
    ...
    Code:
    https://github.com/austintgriffith/Jazzie
...
function App(props) {
  ...
  // 🏗 Jazzie is full of handy hooks like this one to get your balance:
  ...
  */
  ...
  useEffect(() => {
    if (
      ...
      console.log("_____________________________________ 🏗 Jazzie _____________________________________");
            ...
            <div style={{ width: 640, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
              <List
                ...
                renderItem={item => {
                  ...
                  let audio = new Audio(item.music)
