...
const main = async () => {
  ...
  // ADDRESS TO MINT TO:
  const toAddress = "0x6f42C5b1908D2D41B7762Bb1E50E66e5D54e7eB4"
  ...
  const music1 = {
    ...
    "music": "https://citytrend.com.ng/wp-content/uploads/2020/07/Marshmello-ft.-Bastille-Happier.mp3",
    "image": "https://cdn.pixabay.com/photo/2021/08/25/20/42/field-6574455__480.jpg",
    "name": "Happier"
  }
  console.log("Uploading Happier...")
  const uploaded = await ipfs.add(JSON.stringify(music1))
...
*/
  ...
  */
  ...
  // reference: https://github.com/austintgriffith/Jazzie/blob/using-libraries-example/packages/hardhat/scripts/deploy.js#L19
  const yourContract = await deploy("YourContract", [], {}, {
